...
#export STUDY_ID_DIR="Study_id_X_Y_Z_day_exposure"
...
export GENOME_INDEX_ALREADY_AVAILABLE="Yes" #Specify "Yes" or "No"
export RSEM_INDEX_ALREADY_AVAILABLE="Yes"   #Specify "Yes" or "No"
#Specify whether you are working with a large (=human) genome. Specify "Yes" when working with human or "No"
export LARGE_GENOME="No" #Zebrafish genome index keeps failing due to insufficient memory
